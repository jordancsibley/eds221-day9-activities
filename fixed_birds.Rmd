...
# Error in species_id(.) could not find func "species_id"
# Try remove %>%  and do ,  no 
# try remove %>%  and do a $  yes it works now 
...
# Error in groupby(., park_name) : could not find function "groupby"
```
